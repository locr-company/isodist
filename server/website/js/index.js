        ...
        switch (json.type) {
          ...
          case 'FeatureCollection':
            ...
            for (const feature of json.features) {
              ...
              const color = colors[json.features.length - 1 - polygonCounter] || 'white'
              ...
              switch (geometry.type) {
                case 'Polygon':
                  ...
                  if (this.DisplayRadius && feature.properties?.distance) {
                    const circle = L.circle(this.getMarkerCenter(), { color, fill: false, radius: feature.properties.distance * 1000 })
